      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm space-y-4">
          ...
          <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-xs text-slate-600">
            <strong className="text-slate-800">Key Finding:</strong> 79% of rural patients in pilot districts lack 4G smartphones. The Aarogya Vani multichannel engine bridges the digital divide through zero-data 2G GSM access.
          </div>
        </div>
